...
export class Wallet {
  ...
  async startUp() {
    this.walletSelector = await setupWalletSelector({
      network: 'testnet',
      // TODO: Any reason why setupNearWallet is included in the default project?
      modules: [setupNearWallet({ iconUrl: NearIconUrl }), setupMyNearWallet({ iconUrl: MyNearIconUrl }),
